#!/usr/bin/env python3
"""
此示例是升级的深度预览。它具有更高的分辨率（720p），可以显示每一帧（单左右，校正左右，视差和深度）。您可以在代码中选择 6 种模式：
lr_check：用于更好的遮挡处理。欲了解更多信息，https://docs.luxonis.com/en/latest/pages/faq/#left-right-check-depth-mode

extended_disparity：适用于短距离物体。欲了解更多信息，https://docs.luxonis.com/en/latest/pages/faq/#extended-disparity-depth-mode

亚像素：适合远距离。欲了解更多信息，https://docs.luxonis.com/en/latest/pages/faq/#subpixel-disparity-depth-mode
扩展：适用于短距离物体。欲了解更多信息，请单击此处
亚像素：适合远距离。欲了解更多信息，请单击此处
"""
import cv2
import numpy as np
