...
lrcheck: 用于更好的处理阴影。欲了解更多信息， https://docs.luxonis.com/en/latest/pages/faq/#left-right-check-depth-mode
extended: 适用于短距离物体。欲了解更多信息， https://docs.luxonis.com/en/latest/pages/faq/#extended-disparity-depth-mode
subpixel: 适合远距离。欲了解更多信息， https://docs.luxonis.com/en/latest/pages/faq/#subpixel-disparity-depth-mode
"""
import cv2
import numpy as np
